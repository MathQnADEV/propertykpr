                ...
                @forelse ($agents as $agent)
                    <div class="flex items-center justify-between rounded-[16px] bg-[#F8F9FF] border border-[#E8EAFF] px-4 py-3 gap-3">
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                            @if ($agent->whatsapp)
                                <a href="https://wa.me/{{ preg_replace('/\D/', '', $agent->whatsapp) }}?text={{ urlencode('Halo, saya tertarik dengan properti ' . $houseDetails->name) }}"
                                    target="_blank"
                                    class="rounded-xl py-2 px-3 bg-[#25D366] text-white font-semibold text-xs flex items-center gap-1.5 hover:bg-[#1da851] transition-colors">
                            ...
                            @endif
                            @if ($agent->instagram)
                                <a href="https://instagram.com/{{ $agent->instagram }}" target="_blank"
                                    class="rounded-xl py-2 px-3 bg-[#111111] text-white font-semibold text-xs flex items-center gap-1.5 hover:bg-[#333333] transition-colors">
                            ...
                            @endif
                            @if ($agent->facebook)
                                <a href="https://facebook.com/{{ $agent->facebook }}" target="_blank"
                                    class="rounded-xl py-2 px-3 bg-[#555555] text-white font-semibold text-xs flex items-center gap-1.5 hover:bg-[#333333] transition-colors">
