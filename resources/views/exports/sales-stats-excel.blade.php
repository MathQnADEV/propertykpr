<table>
    ...
    <tbody>
        ...
        <tr><td style="color:#16a34a;">KPR Disetujui</td><td style="color:#16a34a;font-weight:bold;">{{ $stats['total_approved'] }}</td></tr>
        ...
        <tr>
            <td style="color:#7c3aed;">Total Nilai Pinjaman (Approved)</td>
            <td style="color:#7c3aed;font-weight:bold;">Rp {{ number_format($stats['total_loan_approved'], 0, ',', '.') }}</td>
        </tr>
        ...
        @if(count($breakdown) > 0)
            ...
            <tr>
                ...
                <td style="font-weight:bold;background-color:#f8fafc;text-align:center;color:#16a34a;">Disetujui</td>
                ...
                <td style="font-weight:bold;background-color:#f8fafc;text-align:right;color:#7c3aed;">Total Pinjaman (Approved)</td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align:center;color:#16a34a;">{{ $row['total_approved'] }}</td>
            ...
            <tr style="font-weight:bold;background-color:#f1f5f9;">
                ...
                <td style="text-align:center;color:#16a34a;">{{ array_sum(array_column($breakdown, 'total_approved')) }}</td>
                ...
                <td style="text-align:right;color:#7c3aed;">Rp {{ number_format(array_sum(array_column($breakdown, 'total_loan_approved')), 0, ',', '.') }}</td>
            </tr>
        @endif
