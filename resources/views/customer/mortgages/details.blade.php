...
@section('title', 'Details Mortgages PropertyKpr')
                            ...
                            <section id="Title" class="flex items-center justify-between">
                                <div class="flex flex-col gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        ...
                                        <p class="font-semibold">{{ $mortgageRequest->house->category->name }},
                                ...
                                @elseif ($mortgageRequest->status == 'Rejected')
                                    <span
                                        class="bg-tedja-red rounded-full text-white py-[6px] px-[10px] font-semibold">Rejected</span>
                                @endif
                            </section>
                            <section id="Points" class="grid grid-cols-3 gap-x-[18px] gap-y-[12px]">
                                ...
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/slider-horizontal.svg') }}" alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">
                                        {{ $mortgageRequest->house->bathroom }} Bathrooms</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp {{ number_format($mortgageRequest->house->price, 0, '', '.') }}
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                        ...
                                        <section id="KPRPaymentDetails"
                                            ...
                                            <div class="flex flex-col gap-4">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp
                                                        {{ number_format($mortgageRequest->loan_total_amount, 0, '', '.') }}
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp
                                                        {{ number_format($mortgageRequest->monthly_amount, 0, '', '.') }}
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-bold text-[20px] leading-[30px] text-tedja-blue">Rp
                                                        {{ number_format($mortgageRequest->loan_interest_total_amount, 0, '', '.') }}
                                                    </strong>
                                                </div>
                                            </div>
                                        </section>
                                        ...
                                        <section id="BankKPRDetails"
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        {{ $mortgageRequest->interestModel->interest }}%
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                    ...
                                                    <strong class="font-semibold">
                                                        {{ $mortgageRequest->duration }} Years
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp
                                                        {{ number_format($mortgageRequest->remaining_loan_amount, 0, '', '.') }}
                                                    </strong>
                                                </div>
                                            ...
                                            @forelse ($mortgageRequest->installments as $installment)
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-[54px]">
                                                        <img src="{{ asset('assets/images/icons/crown-blue-fill.svg') }}" alt="icon"
                                                            class="size-[60px] shrink-0">
                                                        <div class="flex flex-col gap-[2px]">
                                                            <h5 class="text-sm leading-[21px] text-tedja-secondary">Grand
                                                                Total
                                                            </h5>
                                                            <strong class="font-bold">Rp {{ number_format($installment->grand_total_amount, 0, '', '.') }}</strong>
                                                        </div>
                                                    </div>
                                                    <span
                                                    ...
                                                    <div class="flex flex-col gap-[2px]">
                                                        ...
                                                        <strong class="font-bold">Payment of {{ $installment->no_of_payment }}</strong>
                                                    </div>
                                                    <div class="flex flex-col gap-[2px]">
                                                    ...
                                                    <a href="{{ route('dashboard.installment.details', $installment) }}" class="shrink-0">
                                                        <div
