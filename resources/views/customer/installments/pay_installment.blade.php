...
@section('title', 'Pay Installment PropertyKpr')
                        ...
                        <div class="flex flex-col gap-[18px] px-[10px]">
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->category->name  }}, {{ $mortgageRequest->house->city->name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-x-[12px] gap-y-[18px]">
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->bedroom }} Bedrooms</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/slider-horizontal.svg') }}" alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->bathroom }} Bathrooms</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                ...
                                <div class="flex flex-col gap-4" id="KPRPaymentDetailsJ">
                                    ...
                                    <div class="flex flex-col gap-4">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <strong class="font-semibold">Rp {{ number_format($mortgageRequest->remainingLoanAmount, 0, '', '.') }}</strong>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon"
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <strong class="font-semibold">Rp Rp {{ number_format($insurance, 0, '', '.') }}</strong>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon"
