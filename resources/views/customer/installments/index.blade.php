...
@section('title', 'Details Installment PropertyKpr')
                    ...
                    <button id="Profile" class="relative">
                        <div class="flex items-center gap-[14px]">
                            ...
                            <div class="flex rounded-full size-[50px] overflow-hidden">
                                <img src="{{ asset('assets/images/photos/profile.png') }}" class="w-full h-full object-cover" alt="photo">
                            </div>
                        </div>
                        <ul class="hidden absolute top-full mt-[10px] right-0 flex flex-col w-[170px] shrink-0 h-fit text-left rounded-xl border border-tedja-border py-5 px-5 bg-white shadow-[0px_10px_30px_0px_#B8B8B840] gap-[14px]">
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a href="{{ route('logout') }}"
                                        class="hover:text-tedja-blue transition-all duration-300"
            ...
            <main class="flex w-full flex-col justify-center gap-[30px] pt-[28px] pb-[70px]">
                <nav>
                    <ol class="flex items-center gap-[14px]">
                        ...
                        <li>/</li>
                        <li>
                            <a href="{{ route('dashboard.mortgage.details', $installmentDetails->id) }}">Details</a>
                        </li>
                        <li>/</li>
                        <li>
                ...
                <div class="flex gap-[30px]">
                    <section id="Hero" class="flex flex-col h-fit gap-[12px] px-[10px] pt-[10px] pb-[20px] w-[357px] shrink-0 rounded-[30px] border border-[#F2F2F4] bg-white">
                        <div class="w-full h-[240px] rounded-[30px] overflow-hidden justify-center items-center">
                            <img src="{{ Storage::url($installmentDetails->mortgageRequest->house->thumbnail) }}" alt="image" class="size-full object-cover">
                        </div>
                        <div class="flex flex-col gap-[18px] px-[10px]">
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->category->name }}, {{ $installmentDetails->mortgageRequest->house->city->name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-x-[12px] gap-y-[18px]">
                                <div
                                    ...
                                    <img src="{{ asset('assets/images/icons/slider-vertical.svg') }}" alt="icon" class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->bedroom }} Bedrooms</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src="{{ asset('assets/images/icons/slider-horizontal.svg') }}" alt="icon" class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->bathroom }} Bathrooms</p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                    ...
                    <section id="KPRPaymentDetails"
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <strong class="font-semibold">Rp {{ number_format($installmentDetails->sub_total_amount, 0, '', '.') }}</strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                                ...
                                <strong class="font-semibold">Rp {{ number_format($installmentDetails->total_tax_amount, 0, '', '.') }}</strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                                ...
                                <strong class="font-semibold">Rp {{ number_format($installmentDetails->insurance_amount, 0, '', '.') }}</strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                                ...
                                <strong class="font-bold text-[20px] leading-[30px] text-tedja-blue">Rp {{ number_format($installmentDetails->grand_total_amount, 0, '', '.') }}</strong>
                            </div>
                        </div>
                        <hr class="border-[#F2F2F4]">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <strong class="font-semibold">
                                    {{ $installmentDetails->created_at->format('d M, Y') }}
                                </strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                ...
                                <span class="font-semibold text-[#FAFAFA] rounded-full bg-tedja-blue px-[10px] py-[6px]">
                                    {{ $installmentDetails->mortgageRequest->status }}
                                </span>
                            </div>
                        </div>
                    </section>
